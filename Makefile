...
run:
	sudo docker run -d -p 2022:22 -p 8080:8080 -p 9000:9000 -p 27017:27017 -p 6379:6379 -p 5000:5000  --name $(DOCKER_CONTAINER_NAME) -v ${HOST_DIRECTORY}:${CONTAINER_DIRECTORY} ${DOCKER_IMAGE_NAME}
